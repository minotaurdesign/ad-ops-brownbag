...
(function($, window, undefined){
	...
	Fathom.prototype = {
		...
		_setStyles: function() {
			...
			//rich
			//this.$container.css('margin-top', '100px');
		...
		_setMargins: function() {
			var displayMode = this.config.displayMode,
				...
				//verticalSpacing = Math.ceil(($container.height() - this.$firstSlide.innerHeight()) / 2), //original setting
				verticalSpacing = Math.ceil(($container.height() - this.$firstSlide.innerHeight()) / 10),
